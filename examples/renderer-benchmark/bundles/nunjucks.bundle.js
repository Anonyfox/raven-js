  ...
  "node_modules/nunjucks/src/lexer.js"(exports, module) {
    ...
    var Tokenizer = /* @__PURE__ */ (function() {
      function Tokenizer2(str, opts) {
        ...
        var tags2 = opts.tags || {};
        this.tags = {
          BLOCK_START: tags2.blockStart || BLOCK_START,
          BLOCK_END: tags2.blockEnd || BLOCK_END,
          VARIABLE_START: tags2.variableStart || VARIABLE_START,
          VARIABLE_END: tags2.variableEnd || VARIABLE_END,
          COMMENT_START: tags2.commentStart || COMMENT_START,
          COMMENT_END: tags2.commentEnd || COMMENT_END
        };
  ...
  "node_modules/nunjucks/src/parser.js"(exports, module) {
    ...
    var Parser = /* @__PURE__ */ (function(_Obj) {
      ...
      _proto.parseImport = function parseImport() {
        ...
        var node = new nodes.Import(importTok.lineno, importTok.colno, template2, target, withContext);
...
var require_filters = __commonJS({
  "node_modules/nunjucks/src/filters.js"(exports, module) {
    ...
    function striptags(input, preserveLinebreaks) {
      ...
      var tags2 = /<\/?([a-z][a-z0-9]*)\b[^>]*>|<!--[\s\S]*?-->/gi;
      var trimmedInput = trim(input.replace(tags2, ""));
      var res = "";
  ...
  "node_modules/nunjucks/src/precompile-global.js"(exports, module) {
    ...
    function precompileGlobal(templates, opts) {
      ...
      for (var i = 0; i < templates.length; i++) {
        ...
        var template2 = templates[i].template;
...
var require_precompile = __commonJS({
  "node_modules/nunjucks/src/precompile.js"(exports, module) {
    ...
    function _precompile(str, name, env) {
      ...
      name = name.replace(/\\/g, "/");
      try {
        template2 = compiler.compile(str, asyncFilters, extensions, name, env.opts);
      } catch (err) {
              ...
              <footer class="post-stats">
                <div class="engagement-stats">
                  <span class="stat views" title="{{ post.views | number }} views">
                    \u{1F441}\uFE0F {% if post.views > 1000 %}{{ (post.views / 1000) | round }}k{% else %}{{ post.views }}{% endif %}
                  </span>
                  <span class="stat likes" title="{{ post.likes | number }} likes">
                    \u2764\uFE0F {% if post.likes > 1000 %}{{ (post.likes / 1000) | round }}k{% else %}{{ post.likes }}{% endif %}
                  </span>
...
function render() {
  return import_nunjucks.default.renderString(template, data);
}
render();
export {
  render
