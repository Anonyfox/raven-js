  ...
  "node_modules/handlebars/dist/cjs/handlebars/compiler/compiler.js"(exports) {
    ...
    function compile(input, options, env) {
      ...
      function ret(context, execOptions) {
        if (!compiled2) {
          compiled2 = compileInput();
        }
        return compiled2.call(this, context, execOptions);
      }
      ret._setup = function(setupOptions) {
        if (!compiled2) {
          compiled2 = compileInput();
        }
        return compiled2._setup(setupOptions);
      };
      ret._child = function(i, data2, blockParams, depths) {
        if (!compiled2) {
          compiled2 = compileInput();
        }
        return compiled2._child(i, data2, blockParams, depths);
      };
      return ret;
    }
              ...
              <footer class="post-stats">
                <div class="engagement-stats">
                  <span class="stat views" title="{{formatNumber views}} views">
                    \u{1F441}\uFE0F {{#if (gt views 1000)}}{{formatShort views}}k{{else}}{{views}}{{/if}}
                  </span>
...
var compiled = import_handlebars.default.compile(template);
