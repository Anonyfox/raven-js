...
/**
 * @file CSS Lab — Home page
 */

import { html } from "@raven-js/beak/html";

export const title = "CSS Lab";
export const description = "Bootstrap SCSS theming sandbox";
...
<div class="container">
  <div class="page-header" id="banner">
    <div class="row">
      <div class="col-lg-8 col-md-7 col-sm-6">
        <h1>RavenJS CSS Lab</h1>
        <p class="lead">Bootstrap SCSS theming sandbox powered by RavenJS</p>
        <p>Edit <code>scss/themes/default.scss</code>, then run <code>npm run scss:build</code></p>
      </div>
      <div class="col-lg-4 col-md-5 col-sm-6">
        <div class="card">
          <div class="card-body">
            <h5 class="card-title">Quick Actions</h5>
            <a href="#buttons" class="btn btn-primary btn-sm me-2">Buttons</a>
            <a href="#typography" class="btn btn-secondary btn-sm me-2">Typography</a>
            <a href="#forms" class="btn btn-success btn-sm">Forms</a>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- Navbar
  ================================================== -->
  <div class="bs-docs-section my-5">
    <div class="row">
      <div class="col-lg-12">
    ...
    <div class="row">
      <div class="col-lg-4">
        <div class="bs-component">
          ...
          <div class="card bg-danger mb-3" style="max-width: 20rem;">
            <div class="card-header">Header</div>
            <div class="card-body">
