              ...
              <div class="mb-4">
                <div class="d-flex justify-content-between align-items-center mb-2">
                  <div class="small text-muted">
                    <a href="https://docs.ravenjs.dev/beak/modules/sql/" class="text-muted me-2" target="_blank" rel="noopener">📖 Docs</a>
                    <a href="https://github.com/Anonyfox/raven-js/tree/main/packages/beak/sql" class="text-muted" target="_blank" rel="noopener">🔗 Source</a>
                  </div>
                </div>
