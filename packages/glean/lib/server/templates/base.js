...
<head>
	...
	<!-- Favicon -->
	<link rel="icon" type="image/x-icon" href="${urlBuilder ? /** @type {any} */ (urlBuilder).staticUrl("favicon.ico") : "/favicon.ico"}">

	<!-- Bootstrap 5 CSS -->
	<link href="${urlBuilder ? /** @type {any} */ (urlBuilder).staticUrl("bootstrap.min.css") : "/bootstrap.min.css"}" rel="stylesheet">
...
<body>
			...
			<div class="row align-items-start">
				...
				<div class="col-lg-4 col-md-6 mb-3 mb-lg-0">
					<div class="mb-2">
						${
							packageName
								? html`<h6 class="mb-2 fw-semibold text-dark">📦 ${packageName}</h6>`
								: ""
						}
	...
	<script src="${urlBuilder ? /** @type {any} */ (urlBuilder).staticUrl("popper.js") : "/popper.js"}" type="module"></script>
	<script src="${urlBuilder ? /** @type {any} */ (urlBuilder).staticUrl("bootstrap.esm.js") : "/bootstrap.esm.js"}" type="module"></script>
